...
public class MultiplierConfig {
	...
	public MultiplierConfig(EZRanksLite instance) {
	...
	public void createExampleMultiplier() {
		...
		if (!this.dataConfig.contains("rankup_cost_multipliers")) {
			...
			this.dataConfig.set(prefix+".percentage", 0.0);
			save();
		}
	...
	public int loadMultipliers() {
		...
		CostHandler.multipliers = new TreeMap<Integer, Multiplier>();
